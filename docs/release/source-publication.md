...
Public source readiness does not authorize installer publication. Authenticode signing,
Microsoft licensing clarification, and SignPath eligibility remain separate release gates in
...
until all applicable external release gates close.
